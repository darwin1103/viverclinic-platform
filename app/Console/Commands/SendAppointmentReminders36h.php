...
class SendAppointmentReminders36h extends Command
{
     ...
     * @var string
     */
    protected $description = 'Sends email/whatsapp reminders for appointments scheduled between 26 and 36 hours from now.';
    ...
    public function handle(NotificationService $notificationService)
    {
        ...
        foreach ($appointmentsToSendReminder as $appointment) {
            ...
            $appointment->notification_reminder_sent_36 = true;
            $appointment->save();
        }
