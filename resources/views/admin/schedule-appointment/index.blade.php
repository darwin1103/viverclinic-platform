...
<main class="container">
    <div class="">
        ...
        <div class="card my-4">
            <div class="card-body">
                <x-admin.appointment.schedule.index.treatment-header
                    :treatment="$contracted_treatment->treatment"
                    :branch="$contracted_treatment->branch"
                    :attendedCount="$attendedCount"
                    :missedCount="$missedCount"
                    :pendingCount="$pendingCount"
                    :client="$contracted_treatment->user->name"
                />
                ...
                <x-admin.appointment.schedule.index.sessions-table
                    :sessions="$sessions"
...
<x-admin.appointment.schedule.index.appointment-modal />
@endsection
