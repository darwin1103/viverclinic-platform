                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input class="form-control currency-input @error('price_additional_zone') is-invalid @enderror" type="text" inputmode="numeric" id="price_additional_zone" name="price_additional_zone" value="{{ old('price_additional_zone', $treatment->price_additional_zone) }}">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input class="form-control currency-input @error('price_additional_mini_zone') is-invalid @enderror" type="text" inputmode="numeric" id="price_additional_mini_zone" name="price_additional_mini_zone" value="{{ old('price_additional_mini_zone', $treatment->price_additional_mini_zone) }}">
