                ...
                <div class="card-body my-5">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="branchId" class="form-control @error('branchId') is-invalid @enderror" name="branchId" required autocomplete="branchId">
                                    <option value="">Seleccionar</option>
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}" @if(old('branchId') == $branch->id) selected @endif>{{ $branch->name }}</option>
                                    @endforeach
                                </select>
                                @error('branchId')
                                    <span class="invalid-feedback" role="alert">
