<div class="card mb-4">
    <div class="card-body">
        <form action="{{ route('admin.owner.index') }}" method="GET" id="filter-form">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-12 col-md-4 d-grid">
                    <a href="{{ route('admin.owner.index') }}" class="btn btn-secondary"><i class="bi bi-eraser-fill"></i> Limpiar</a>
                </div>
