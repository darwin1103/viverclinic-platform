                    ...
                    <td class="text-end">
                        ...
                        @elseif (isset($session) && $session['schedule'])
                            <button
                                ...
                                data-confirm-url="{{ route('client.schedule-appointment.confirm', ['appointment' => $session['id']]) }}"
                                data-resched-url="{{ route('client.schedule-appointment.resched', ['appointment' => $session['id']]) }}"
                                data-cancel-url="{{ route('client.schedule-appointment.cancel', ['appointment' => $session['id']]) }}"
